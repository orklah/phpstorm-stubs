...
namespace Couchbase {
     ...
     * @see https://github.com/couchbaselabs/sdk-rfcs RFC-20 at SDK RFCs repository
     */
    function basicEncoderV1($value, array $options) {}
    ...
    class Cluster {
         ...
         */
        public function authenticate(\Couchbase\Authenticator $authenticator) {}
    ...
    class ClusterManager {
         ...
         */
        public function createBucket(string $name, array $options = []) {}
         ...
         */
        public function listUsers(int $domain = RBAC_DOMAIN_LOCAL) {}
         ...
         * @see \Couchbase\ClusterManager::RBAC_DOMAIN_EXTERNAL
         */
        public function getUser(string $username, int $domain = RBAC_DOMAIN_LOCAL) {}
         ...
         * @see \Couchbase\ClusterManager::RBAC_DOMAIN_EXTERNAL
         */
        public function upsertUser(string $name, \Couchbase\UserSettings $settings, int $domain = RBAC_DOMAIN_LOCAL) {}
         ...
         * @see \Couchbase\ClusterManager::RBAC_DOMAIN_EXTERNAL
         */
        public function removeUser(string $name, int $domain = RBAC_DOMAIN_LOCAL) {}
    }
    ...
    class UserSettings {
         ...
         *   More details
         */
        public function role(string $role, string $bucket = NULL) {}
    }
    ...
    class Bucket {
         ...
         *   More details about K/V operations for PHP SDK
         */
        public function getAndTouch($ids, int $expiry, array $options = []) {}
         ...
         */
        public function getFromReplica($ids, array $options = []) {}
         ...
         *   More details about K/V operations for PHP SDK
         */
        public function append($ids, $value, array $options = []) {}
         ...
         *   More details about K/V operations for PHP SDK
         */
        public function prepend($ids, $value, array $options = []) {}
         ...
         *   More details about K/V operations for PHP SDK
         */
        public function unlock($ids, array $options = []) {}
         ...
         *   More details about K/V operations for PHP SDK
         */
        public function touch($ids, int $expiry, array $options = []) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function retrieveIn(string $id, ...$paths) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function mutateIn(string $id, string $cas) {}
         ...
         */
        public function query(\Couchbase\N1qlQuery $query, bool $jsonAsArray = false) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function mapSize(string $id) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function mapAdd(string $id, string $key, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function mapRemove(string $id, string $key) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function mapGet(string $id, string $key) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function setSize(string $id) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function setAdd(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function setExists(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function setRemove(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function listSize(string $id) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function listPush(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function listShift(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function listRemove(string $id, int $index) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function listGet(string $id, int $index) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function listSet(string $id, int $index, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function listExists(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function queueSize(string $id) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function queueExists(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function queueAdd(string $id, $value) {}
         ...
         *   Overview of Sub-Document Operations
         */
        public function queueRemove(string $id) {}
         ...
         */
        public function ping(int $services = 0, string $reportId = NULL) {}
         ...
         *   SDK RFC #34, which describes the feature and report layout.
         */
        public function diag(string $reportId = NULL) {}
         ...
         */
        public function encryptFields(array $document, $fieldOptions, string $prefix = null) {}
         ...
         * @see https://github.com/couchbase/php-couchbase-encryption
         */
        public function decryptFields(array $document, $fieldOptions, string $prefix = null) {}
    }
    ...
    class BucketManager {
         ...
         * @return array
         */
        public function getDesignDocument(string $name) {}
         ...
         * @param string $name name of the design document (without _design/ prefix)
         */
        public function removeDesignDocument(string $name) {}
         ...
         */
        public function upsertDesignDocument(string $name, array $document) {}
         ...
         * @param array $document
         */
        public function insertDesignDocument(string $name, array $document) {}
         ...
         */
        public function createN1qlPrimaryIndex(string $customName = '', bool $ignoreIfExist = false, bool $defer = false) {}
         ...
         * @param bool $defer true to defer index building.
         */
        public function createN1qlIndex(string $name, array $fields, string $whereClause = '', bool $ignoreIfExist = false, bool $defer = false) {}
         ...
         *   will be thrown unless this is set to true.
         */
        public function dropN1qlPrimaryIndex(string $customName = '', bool $ignoreIfNotExist = false) {}
         ...
         *   will be thrown unless this is set to true.
         */
        public function dropN1qlIndex(string $name, bool $ignoreIfNotExist = false) {}
    }
    ...
    class ClassicAuthenticator implements Authenticator {
         ...
         */
        public function cluster(string $username, string $password) {}
         ...
         */
        public function bucket(string $name, string $password) {}
    }
    ...
    class MutationToken {
         ...
         */
        public static function from(string $bucketName, int $vbucketId, string $vbucketUuid, string $sequenceNumber) {}
    ...
    class ViewQuery implements ViewQueryEncodable {
         ...
         * @return ViewQuery
         */
        public static function from(string $designDocumentName, string $viewName) {}
         ...
         */
        public static function fromSpatial(string $designDocumentName, string $viewName) {}
         ...
         * @return ViewQuery
         */
        public function reduce(bool $reduce) {}
         ...
         */
        public function group(bool $group) {}
         ...
         */
        public function groupLevel(int $groupLevel) {}
         ...
         * @return ViewQuery
         */
        public function range($startKey, $endKey, bool $inclusiveEnd = false) {}
         ...
         * @return ViewQuery
         */
        public function idRange(string $startKeyDocumentId, string $endKeyDocumentId) {}
         ...
         *   Getting Views Information
         */
        public function custom(array $customParameters) {}
    }
    ...
    class SpatialViewQuery implements ViewQueryEncodable {
         ...
         */
        public function bbox(array $bbox) {}
         ...
         *   Querying spatial views
         */
        public function startRange(array $range) {}
         ...
         *   Querying spatial views
         */
        public function endRange(array $range) {}
    ...
    class N1qlQuery {
         ...
         * @return N1qlQuery
         */
        public function adhoc(bool $adhoc) {}
         ...
         * @see \Couchbase\ClassicAuthenticator
         */
        public function crossBucket(bool $crossBucket) {}
         ...
         */
        public function profile(string $profileType) {}
        /**
         ...
         */
        public function consistentWith(\Couchbase\MutationState $state) {}
         ...
         * @return N1qlQuery
         */
        public function scanCap(int $scanCap) {}
         ...
         * @return N1qlQuery
         */
        public function pipelineBatch(int $pipelineBatch) {}
         ...
         * @return N1qlQuery
         */
        public function pipelineCap(int $pipelineCap) {}
         ...
         * @return N1qlQuery
         */
        public function maxParallelism(int $maxParallelism) {}
    }
    ...
    class LookupInBuilder {
         ...
         * @return LookupInBuilder
         */
        public function getCount(string $path, array $options = []) {}
         ...
         * @return LookupInBuilder
         */
        public function exists(string $path, array $options = []) {}
    ...
    class MutateInBuilder {
         ...
         * @return MutateInBuilder
         */
        public function insert(string $path, $value, $options = []) {}
         ...
         */
        public function modeDocument(int $mode) {}
         ...
         * @return MutateInBuilder
         */
        public function upsert(string $path, $value, $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function replace(string $path, $value, array $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function remove(string $path, array $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function arrayPrepend(string $path, $value, $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function arrayPrependAll(string $path, array $values, $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function arrayAppend(string $path, $value, $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function arrayAppendAll(string $path, array $values, $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function arrayInsert(string $path, $value, array $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function arrayInsertAll(string $path, array $values, array $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function arrayAddUnique(string $path, $value, $options = []) {}
         ...
         * @return MutateInBuilder
         */
        public function counter(string $path, int $delta, $options = []) {}
    ...
    class SearchQuery implements \JsonSerializable {
         ...
         */
        public static function booleanField(bool $value) {}
         ...
         */
        public static function match(string $match) {}
         ...
         */
        public static function queryString(string $queryString) {}
         ...
         */
        public static function wildcard(string $wildcard) {}
         ...
         */
        public static function geoDistance(float $longitude, float $latitude, string $distance) {}
         ...
         */
        public static function geoBoundingBox(float $topLeftLongitude, float $topLeftLatitude, float $bottomRightLongitude, float $bottomRightLatitude) {}
         ...
         */
        public static function termFacet(string $field, int $limit) {}
         ...
         */
        public static function dateRangeFacet(string $field, int $limit) {}
         ...
         */
        public static function numericRangeFacet(string $field, int $limit) {}
         ...
         */
        public function __construct(string $indexName, \Couchbase\SearchQueryPart $queryPart) {}
         ...
         * @return SearchQuery
         */
        public function serverSideTimeout(int $serverSideTimeout) {}
         ...
         */
        public function highlight(string $style, ...$fields) {}
         ...
         */
        public function addFacet(string $name, \Couchbase\SearchFacet $facet) {}
    }
    ...
    class DateRangeSearchQuery implements \JsonSerializable, SearchQueryPart {
         ...
         * @return DateRangeSearchQuery
         */
        public function start($start, bool $inclusive = true) {}
         ...
         * @return DateRangeSearchQuery
         */
        public function end($end, bool $inclusive = false) {}

        /**
         * @param string $dateTimeParser
         * @return DateRangeSearchQuery
         */
        public function dateTimeParser(string $dateTimeParser) {}
    }
    ...
    class NumericRangeSearchQuery implements \JsonSerializable, SearchQueryPart {
         ...
         * @return NumericRangeSearchQuery
         */
        public function min(float $min, bool $inclusive = true) {}
         ...
         * @return NumericRangeSearchQuery
         */
        public function max(float $max, bool $inclusive = false) {}
    }
    ...
    class TermRangeSearchQuery implements \JsonSerializable, SearchQueryPart {
         ...
         * @return TermRangeSearchQuery
         */
        public function min(string $min, bool $inclusive = true) {}
         ...
         * @return TermRangeSearchQuery
         */
        public function max(string $max, bool $inclusive = false) {}
    }
    ...
    class DateRangeSearchFacet implements \JsonSerializable, SearchFacet {
         ...
         */
        public function addRange(string $name, $start, $end) {}
    }
    ...
    class NumericRangeSearchFacet implements \JsonSerializable, SearchFacet {
         ...
         */
        public function addRange(string $name, float $min, float $max) {}
    }
    ...
    class SearchSort {
         ...
         */
        public static function geoDistance(string $field, float $longitude, float $latitude) {}
    }
