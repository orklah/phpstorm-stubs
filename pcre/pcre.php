 ...
 * @since 5.0
 */
function preg_replace_callback ($regex, callable $callback, $subject, int $limit = -1, int &$count = null, $flags=[]) {}
 ...
 */
function preg_replace_callback_array (array $patterns_and_callbacks, $subject , int $limit = -1, int &$count = null, $flags = []) {}
